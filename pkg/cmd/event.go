...
var eventsList = requestflag.WithInnerFlags(cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "associated-object-id",
			Usage:     "Filter Events to those belonging to the object with the provided identifier.",
			QueryPath: "associated_object_id",
		},
	...
	"category": {
		&requestflag.InnerFlag[[]string]{
			Name:       "category.in",
			Usage:      "Filter Events for those with the specified category or categories. For GET requests, this should be encoded as a comma-delimited string, such as `?in=one,two,three`.",
			InnerField: "in",
		},
	},
	"created-at": {
