...
func TestCardPurchaseSupplementsRetrieve(t *testing.T) {
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"card-purchase-supplements", "retrieve",
			"--card-purchase-supplement-id", "card_purchase_supplement_ijuc45iym4jchnh2sfk3",
		)
	})
}

func TestCardPurchaseSupplementsList(t *testing.T) {
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"card-purchase-supplements", "list",
			"--max-items", "10",
			"--card-payment-id", "card_payment_id",
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		requestflag.CheckInnerFlags(cardPurchaseSupplementsList)
