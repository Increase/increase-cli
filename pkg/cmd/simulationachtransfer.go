...
var simulationsACHTransfersCreateNotificationOfChange = cli.Command{
	...
	Flags: []cli.Flag{
		...
		&requestflag.Flag[string]{
			Name:     "corrected-account-funding",
			Usage:    "The corrected account funding type.",
			BodyPath: "corrected_account_funding",
		},
		&requestflag.Flag[string]{
			Name:     "corrected-account-number",
			Usage:    "The corrected account number.",
			BodyPath: "corrected_account_number",
		},
		&requestflag.Flag[string]{
			Name:     "corrected-individual-id",
			Usage:    "The corrected individual identifier.",
			BodyPath: "corrected_individual_id",
		},
		&requestflag.Flag[string]{
			Name:     "corrected-routing-number",
			Usage:    "The corrected routing number.",
			BodyPath: "corrected_routing_number",
		},
	},
