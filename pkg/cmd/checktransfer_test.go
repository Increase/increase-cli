...
func TestCheckTransfersCreate(t *testing.T) {
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		mocktest.TestRunMockTestWithFlags(
			...
			"--balance-check", "full",
			"--check-number", "x",
			"--physical-check.mailing-address", "{city: New York, line1: 33 Liberty Street, postal_code: '10045', state: NY, line2: x, name: Ian Crease, phone: '+16505046304'}",
			...
			"--physical-check.note", "x",
			"--physical-check.payer", "[{contents: x}]",
			"--physical-check.return-address", "{city: x, line1: x, name: x, postal_code: x, state: x, line2: x, phone: x}",
