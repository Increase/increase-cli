...
The official CLI for the [Increase REST API](https://increase.com/documentation).
...
You can link the CLI against a different version of the Increase Go SDK
...
```bash
./scripts/link ../path/to/increase-go
```

If you run the link script without any arguments, it will default to `../increase-go`.
